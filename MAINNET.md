...
Authority: [DOCTRINE.md](DOCTRINE.md). Related: [STABLES-GUIDE.md](STABLES-GUIDE.md) (pegs and capital ladder), [VISION.md](VISION.md) (finished conversation on a phone), [KACHAT.md](KACHAT.md) (chat + pay), [BATTLE.md](BATTLE.md) (PegLab vs Parker’s GitHub PoC).
